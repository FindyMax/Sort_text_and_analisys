package com.example.case_insensitive_sort;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView output1; // поле вывода результата на экран смартфона
...
//         вывод проанализированных данных на экран смартфона
        ...
        output1.append(sort(poemArray));
    }

    // метод сортировки
    private String sort(String[] wordArray) {

        String worldResult = "все слова:\n";
        Arrays.sort(wordArray);
        for (String i : wordArray) {
            worldResult += "\n" + i;
        }
//        String [] wordArraySorted1 = new String[wordArray.length];
//        String [] wordArrayUpper;
//        String [] wordArrayLower;
//        int endUpper;
//        for (String i : wordArray) {
//            if (i.equals(i.toLowerCase())) endUpper = Arrays.asList(wordArray).indexOf(i); break;
//        }
//        List<String> wordArray1 = Arrays.asList(wordArray);
//        for (String i : wordArray) {
//            int index = wordArray1.indexOf(i);
//            wordArraySorted1[index] = i.toLowerCase();
//            worldResult += "\n" + i;
//        }
//        Arrays.sort(wordArraySorted1);
//        String [] wordArraySorted = new String[wordArray.length];
//        for (String i : wordArraySorted1) {
//            for (int j = 0; j < wordArray.length; j++) {
//                if (wordArray[j].toLowerCase().equals(i)) worldResult += "\n" + wordArray[j]; wordArray[j] = ""; break;
//            }
//        }
